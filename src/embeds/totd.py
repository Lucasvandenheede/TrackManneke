...
class TOTDEmbed:
    """Builder for TOTD leaderboard Discord embeds."""
    ...
    def build(map_data: Dict[str, Any], belgian_entries: List[Dict[str, Any]]) -> discord.Embed:
        """Build the full TOTD leaderboard embed.

        Args:
            map_data: Map metadata (from TOTDClient.get_current_totd).
            belgian_entries: List of Belgian player leaderboard entries.
